...
def bilinear_interpolation(image, scale, x, y):
    """
    Perform bilinear interpolation on an image after scaling.
...
if __name__ == "__main__":
    ...
    scale = 4.0  # Scaling factor
    x, y = 8, 0  # Coordinates in the scaled image

    value = bilinear_interpolation(image, scale, x, y)
