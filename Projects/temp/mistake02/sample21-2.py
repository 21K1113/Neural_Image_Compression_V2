...
def create_decoder_input(fp, coord, num_crops, fl, mip_level):
    ...
    for i in range(num_crops):
        g0_0, g0_1, g0_2, g0_3, g1_0, g1_1, g1_2, g1_3, pe = create_g0_g1(fp, fl, coord[i][1], coord[i][0],
...
def train_models(fp):
    ...
    for epoch in range(num_epochs):
        ...
        psnr = calculate_psnr(quantize(decoder_output), quantize(target))
...
def process_images(train_model, fp):
    if train_model:
        ...
        compressed_fp = []
        for g in fp:
            quantized_g = quantize(g, num_bits)
