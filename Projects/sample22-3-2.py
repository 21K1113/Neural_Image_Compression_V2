...
if no_mip:
    max_mip_level = 0
decoder_input_channels = feature_pyramid_channels * 5 + pe_channels * 3 + 1
...
save_result_to_csv(movie_original, make_filename_by_seq(f'LUT/{save_name}', f'{save_name}.csv'))
images = []
for i in range(max_mip_level + 1):
    # [T, H, W, C] -> [C, T, H, W]
